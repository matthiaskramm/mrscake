...
data.train([2,0.3,3,0.0,"A",3], output="no")
data.train([1,1.1,3,0.5,"C",7], output="no")
data.train([2,0.7,3,1.0,"A",4], output="yes")
data.train([2,0.7,3,1.0,"D",7], output="bla")
data.train([1,0.6,3,1.0,"A",7], output="bla")
data.train([1,0.6,3,2.0,"B",8], output="bla")
data.train([1,0.6,3,1.0,"A",9], output="bla")
data.train([2,0.7,3,1.0,"A",7], output="yes")
data.train([1,1.1,5,0.0,"B",10], output="no")
print data
